...
# Example usage:
folder_path = "/Users/ramyyogeshkumarsolanki/Documents/GitHub/Assignment3/airflow/downloads"  # Specify the path to the folder you want to upload
bucket = "publications-info"  # Specify the S3 bucket name
